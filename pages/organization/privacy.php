<html>
    ...
    <body>    
        ...
        <div id="main-content">
            ...
            <p>We use Google's sign-in system to keep track of users of our platform. Note the sign-in button in the top-right corner. This system works by authorizing the user through Google's authentication system, then relaying the account name and email back to our system (Note that we never have access to anything beyond your name, email address, and profile picture). Your email address is then used to track what videos you create captions for and review, which is accomplished by temporarily storing a hashed version of your email address in a self-hosted database. These email address records are deleted once a set of captions have been approved or rejected from the review system and are never stored in a plaintext format. This ensure that should a malicious actor gain access to our database, they are left with incomprehensible text as opposed to a list of emails. This is part of our abuse mitigation system, which you can <a href="#abuse">learn more about here</a>.</p>
